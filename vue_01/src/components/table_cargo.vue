        ...
        <el-row>
            <el-col>
                <el-table :data="tableData" border height="850px" style="width: 100%" :row-class-name="tableRowClassName">
                    <el-table-column prop="cargo_id" label="货物捆包号" width="100">
                    </el-table-column>
                    <el-table-column prop="cargo_name" label="货物名" width="180">
                    </el-table-column>
                                ...
                                <span>
                                    <el-form ref="form" :model="form">
                                        <el-form-item label="货物捆包号" :label-width="formLabelWidth">
                                            <el-input :disabled="true" v-model="editform.cargo_id"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="货物名" :label-width="formLabelWidth">
                                            <el-input v-model="editform.cargo_name" autocomplete="off"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="订单编号" :label-width="formLabelWidth">
                                            <el-input v-model="editform.order_id" autocomplete="off"></el-input>
                                        </el-form-item>
                            ...
                            <el-dialog title="添加信息" :visible.sync="adddialogVisible">
                                <span>
                                    <el-form ref="form" :model="form">
                                        ...
                                        <el-form-item label="货物名" :label-width="formLabelWidth">
                                            <el-input v-model="addform.cargo_name" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="货物重量" :label-width="formLabelWidth">
                                            <el-input v-model="addform.weight" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="货物状态" :label-width="formLabelWidth">
                                            <el-select v-model="addform.status" placeholder="请选择性别">
                                                <el-option label="未发货" value="未发货"></el-option>
                                                <el-option label="运输中" value="运输中"></el-option>
                                                <el-option label="已送达" value="已送达"></el-option>
                                            </el-select>
                                        ...
                                        <el-form-item label="订单编号" :label-width="formLabelWidth">
                                            <el-input v-model="addform.order_id" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="备注" :label-width="formLabelWidth">
        ...
        handleadd() {
            axios.get('http://localhost:8080/cargo/add', {
                params: {
                    ...
                    cargo_name: this.addform.cargo_name,
