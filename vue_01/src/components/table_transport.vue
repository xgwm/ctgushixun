        ...
        <el-row>
            <el-col>
                <el-table :data="tableData" border height="850px" style="width: 100%"
                    ...
                    <el-table-column prop="transport_id" label="运单编号" width="100">
                    </el-table-column>
                    <el-table-column prop="cargo_id" label="货物捆绑号" width="180">
                    </el-table-column>
                    <el-table-column prop="license_plate" label="车牌号码" width="180">
                    </el-table-column>
                    <el-table-column prop="driver_name" label="司机名称" width="180">
                    </el-table-column>
                    <el-table-column prop="driver_tel" label="司机电话" width="100">
                    </el-table-column>
                    <el-table-column prop="send_address" label="发货地址" width="250">
                    </el-table-column>
                    <el-table-column prop="receive_address" label="收货地址" width="250">
                    </el-table-column>
                    <el-table-column prop="amount" label="运费" width="250">
                    </el-table-column>
                                ...
                                <span>
                                    <el-form ref="form" :model="form">
                                        ...
                                        <el-form-item label="货物捆绑号" :label-width="formLabelWidth">
                                            <el-input v-model="editform.cargo_id" autocomplete="off"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="发货地址" :label-width="formLabelWidth">
                                            <el-input v-model="editform.send_address" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="收货地址" :label-width="formLabelWidth">
                                            <el-input v-model="editform.receive_address" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                            ...
                            <el-dialog title="添加信息" :visible.sync="adddialogVisible">
                                <span>
                                    <el-form ref="form" :model="form">
                                        ...
                                        <el-form-item label="货物捆绑号" :label-width="formLabelWidth">
                                            <el-input v-model="addform.cargo_id" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="车牌号码" :label-width="formLabelWidth">
                                            <el-input v-model="addform.license_plate" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="司机名称" :label-width="formLabelWidth">
                                            <el-input v-model="addform.driver_name" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="司机电话" :label-width="formLabelWidth">
                                            <el-input v-model="addform.driver_tel" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="发货地址" :label-width="formLabelWidth">
                                            <el-input v-model="addform.send_address" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="收货地址" :label-width="formLabelWidth">
                                            <el-input v-model="addform.receive_address" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="运费" :label-width="formLabelWidth">
        ...
        handleadd() {
            axios.get('http://localhost:8080/transport/add', {
                params: {
                    ...
                    cargo_id: this.addform.cargo_id,
                    license_plate: this.addform.license_plate,
                    driver_name: this.addform.driver_name,
                    driver_tel: this.addform.driver_tel,
                    send_address: this.addform.send_address,
                    receive_address: this.addform.receive_address,
